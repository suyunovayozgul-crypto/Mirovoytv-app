...
export default function App() {
  ...
  const refreshEpg = useCallback(() => {
    fetchEpg()
      .then((data) => {
        setEpg(data);
        // Keyingi ochilishda darhol ko'rsatish uchun saqlaymiz. EPG
        // ba'zan juda katta bo'lishi mumkin — xato chiqsa (masalan
        // xotira cheklovi), shunchaki keshlamasdan davom etamiz, bu
        // ilovaning ishlashiga ta'sir qilmaydi.
        serializeEpg2SafeStore(data);
      })
      .catch(() => {});
  }, [serializeEpg2SafeStore]);
  useEffect(() => {
    (async () => {
      try {
