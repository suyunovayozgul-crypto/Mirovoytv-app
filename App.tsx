      ...
      <SafeAreaView style={styles.playerRoot}>
        ...
        <VLCPlayer
          ...
          source={{
            ...
            initType: 2,
            hwDecoderEnabled: 1,
            // MUHIM: "majburiy" (forced) emas — agar qurilma apparat
            // dekoderini to'liq qo'llab-quvvatlamasa, "forced" holatda
            // libVLC darhol (native darajada) qulab tushadi. "Yoqilgan,
            // lekin majburiy emas" holatda esa mos kelmasa, avtomatik
            // dasturiy (software) dekoderga o'tadi — xavfsizroq.
            hwDecoderForced: 0,
